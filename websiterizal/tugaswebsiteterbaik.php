...
<header class="header">
        ...
        <ul class="nav-menu">
            <li><a href="tugaswebsiteterbaik.php?page=tentangitb" title="Tentang ITB">Tentang ITB</a></li>
            <li><a href="tugaswebsiteterbaik.php?page=penerimaan" title="Penerimaan">Penerimaan</a></li>
            <li><a href="tugaswebsiteterbaik.php?page=pendidikan" title="Pendidikan">Pendidikan</a></li>
            <li><a href="tugaswebsiteterbaik.php?page=penelitian" title="Penelitian">Penelitian</a></li>
            <li><a href="tugaswebsiteterbaik.php?page=pengabdian" title="Pengabdian">Pengabdian</a></li>
            <li><a href="tugaswebsiteterbaik.php?page=penghargaan" title="Penghargaan">Penghargaan</a></li>
            <li><a href="tugaswebsiteterbaik.php?page=multikampus" title="Multikampus">Multikampus</a></li>
            <li><a href="tugaswebsiteterbaik.php?page=kontak" title="Kontak">Kontak</a></li>
            <div class="menu-container">
                ...
                <div id="dropdownMenu" class="dropdown-content">
                    ...
                    <a href="admin/signup.php">Register</a>
                </div>
            </div>
        </ul>
    </header>
